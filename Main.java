public class Main {
    public static void main(String[] args) {
        ...
        for(Abteilung iabt : HTL.getAbteilungen()){
            if(iabt.getKuerzel() == "EL"){
                Lehrer abv = new Lehrer(321L, "Wolfgang", "Kuran", "01.01.1919", "wolfgang.kuran@htlstp.at",new Adresse("STP", "Waldstraße", 99, 1234), "KURA");
                ...
                iabt.addKlasse(new Klasse("4AHELS",4, AHkv, AHksp, new Raum(),iabt, AHksp));
                iabt.addKlasse(new Klasse("4BHELS", 4, BHkv, BHksp, new Raum(), iabt, BHksp));
                ...
                iabt.setAbteilungssprecher(asprecher);
            }
            else if(iabt.getKuerzel() == "ET"){
